...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl 3xl:text-7xl font-semibold mx-auto leading-[1.2]">
        Unleash Your Creativity <br />
        with Powerful <span className=" text-primary">AI Tools</span>
      </h1>
    <p className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl mx-auto max-sm:text-xs text-gray-600">
    Empower your creativity with our suite of AI-powered tools. From writing and image generation to workflow optimization — we’ve got you covered.</p>
  </div>
